...
EVT\(_pf\) algorithm is optimal in that its upper bound matches the
...
\subsubsection{Likelihood Ratio for Univariate Exponential Family of
Distributions}\label{likelihood-ratio-for-univariate-exponential-family-of-distributions}
...
\begin{align*}
B_i^{SLR_{2D}}(t+1) & = -\log(LR(\tau, \sigma_{\tau,i}^2(t)||\hat{\mu}_i(t),\hat{\sigma}^2_{i}(t))) \\
& = T_i(t) \log\Big(\frac{\sigma_{\tau,i}^2(t)}{\hat{\sigma}_i^2(t)}\Big) \\
& = T_i(t) KL(N(\hat{\mu}_i(t),\hat{\sigma}^2_{i}(t))||N(\tau, \sigma_{\tau,i}^2(t)))
\end{align*}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/simulation1_results-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/simulation2_results-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-2-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/simulation3_results-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/simulation4_results-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/simulation5_results-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-5-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-7-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-7-2} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-7-3} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-7-4} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{Draft_files/figure-latex/unnamed-chunk-9-1} \end{center}
