...
```{r, echo = FALSE, message = FALSE, fig.align = "center", out.width = '70%', fig.cap = "Budget allocation across arms for APT and SLR algorithms in simulation 2."}
