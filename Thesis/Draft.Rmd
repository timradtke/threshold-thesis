...
Consider an example in which we assume that the sample stems from a normal distribution with unknown mean but known variance $\sigma^2 = 1$ such that $X_i \sim N(\mu, 1)$. We test $H_0: \mu = \mu_0$ against $H_1: \mu = \mu_1$. 
