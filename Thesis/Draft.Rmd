...
knitr::kable(rbind(Training, Test, TrainingMinusTau)[,order(Training)], digits = 3, col.names = names(data_amo3_mean_firsthalf),
...
alg_names <- c(rep(c("Uniform", "APT", "AugUCB","LR"), 
                   each = 10071), rep("EVT", 10061))
index <- c(rep(10:10080, times = 4), 20:10080)
alg_res <- log(c(amo3_comp_UNIFORM, amo3_comp_APT, amo3_comp_AugUCB, amo3_comp_LR, amo3_comp_EVT))
...
knitr::kable(rbind(Training, Test, TrainingMinusTau)[,order(Training)], digits = 3, col.names = names(data_amo4_mean_firsthalf),
             caption = "Count rates for ten products for both training and test sample.")
...
alg_names <- c(rep(c("Uniform", "APT", "AugUCB","LR", "B-UCB"), 
                   each = 10071), rep("EVT", 10061))
