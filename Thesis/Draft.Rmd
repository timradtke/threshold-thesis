...
In the case of $\tau = 0.5$, the latter KL-divergence is symmetric in its first argument, and thus can be relatively well approximated by Pinsker's inequality (SHOW IN GRAPH!):
...
## Variance Based Algorithms for Thresholding Bandits \label{chap:VarianceBasedAlgorithms}
...
## Likelihood Ratio for Exponential Family Distributions \label{sec:LikelihoodRatioForExponentialFamily}
